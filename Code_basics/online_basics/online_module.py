...
def gen_text_from_audio_openai(client, audio_file, model = "whisper-1", response_format = "text"):
...
def main():
    ...
    prompt = st.text_input("Enter your prompt", placeholder="Write an essay on computer vision")
